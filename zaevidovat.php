...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar fixed-top navbar-expand-lg border-dark border-3 border-bottom border-body" style="background: linear-gradient(rgb(216, 210, 194), rgb(250, 247, 240));">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link ms-3 fw-medium active" href="zaevidovat.html">CESTOVNÁ REGISTRÁCIA</a>
                </li>
                </ul>
                <form class="d-flex" role="search">
                <input class="form-control me-2 border-2 border-dark fw-medium" style="background: rgb(250, 247, 240);" type="search" placeholder="Hľadať..." aria-label="Search">
                <button class="btn btn-outline-dark border-2 fw-medium" type="submit">Hľadať</button>
                </form>
            </div>
            </div>
        </nav>
